...
class FlavaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        image_codebook_config_dict = kwargs.pop(
            "image_codebook_config_dict", None)
        ...
        if image_config_dict is not None:
            ...
            _image_config_dict = FlavaImageConfig(
                **image_config_dict).to_dict()
        ...
        if multimodal_config_dict is not None:
            ...
            _multimodal_config_dict = FlavaMultimodalConfig(
                **multimodal_config_dict).to_dict()
        ...
        if image_codebook_config_dict is not None:
            ...
            _image_codebook_config_dict = FlavaImageCodebookConfig(
                **image_codebook_config_dict).to_dict()
