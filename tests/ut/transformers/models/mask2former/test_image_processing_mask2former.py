...
class Mask2FormerImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    ...
    def test_integration_instance_segmentation(self):
        ...
        self.assertTrue(np.allclose(inputs["class_labels"][0].asnumpy(), mindspore.tensor([30, 55]).asnumpy()))
        self.assertTrue(np.allclose(inputs["class_labels"][1].asnumpy(), mindspore.tensor([4, 4, 23, 55]).asnumpy()))
    ...
    def test_integration_semantic_segmentation(self):
        ...
        # verify the class labels
        self.assertEqual(len(inputs["class_labels"]), 2)
        self.assertTrue(np.allclose(inputs["class_labels"][0].asnumpy(), mindspore.tensor([2, 4, 60]).asnumpy()))
        self.assertTrue(np.allclose(inputs["class_labels"][1].asnumpy(), mindspore.tensor([0, 3, 7, 8, 15, 28, 30, 143]).asnumpy()))
    ...
    def test_integration_panoptic_segmentation(self):
        ...
        self.assertTrue(np.allclose(inputs["class_labels"][0].asnumpy(), mindspore.tensor(expected_class_labels).asnumpy()))
        ...
        self.assertTrue(np.allclose(inputs["class_labels"][1].asnumpy(), expected_class_labels.asnumpy()))
